...
class MyRectangle : public MyCanvas
{
public:
    ...
    MyRectangle operator*(unsigned int i)
    {
        ...
        MyRectangle *modified_rect = new MyRectangle{*canvas_ptr, this->x1, this->y1, ((this->x2 - this->x1) * i) + this->x1, ((this->y2 - this->y1) * i) + this->y1};
    ...
    void draw() { canvas_ptr->draw_rectangle(this->x1, this->y1, this->x2, this->y2); };
